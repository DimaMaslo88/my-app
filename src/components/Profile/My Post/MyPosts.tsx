...
import {addNewPostAC, changePostAC} from "../../redux/profile-reducer";


export function MyPosts(props: any) {

    let postElements = props.post.map((m: any) => <Posts key={m.id} message={m.message} likesCount={m.likesCount}/>)
